...
public class PurchaseOrderItemProvider 
	...
	public Collection<? extends EStructuralFeature> getChildrenFeatures(Object object) {
		if (childrenFeatures == null) {
			...
			childrenFeatures.add(PpoPackage.Literals.PURCHASE_ORDER__SHIP_TO);
			childrenFeatures.add(PpoPackage.Literals.PURCHASE_ORDER__BILL_TO);
	...
	protected void collectNewChildDescriptors(Collection<Object> newChildDescriptors, Object object) {
		...
		newChildDescriptors.add
			(createChildParameter
				(PpoPackage.Literals.PURCHASE_ORDER__SHIP_TO,
				 PpoFactory.eINSTANCE.createUSAddress()));

		newChildDescriptors.add
			(createChildParameter
				(PpoPackage.Literals.PURCHASE_ORDER__BILL_TO,
				 PpoFactory.eINSTANCE.createUSAddress()));
	...
	public String getCreateChildText(Object owner, Object feature, Object child, Collection<?> selection) {
		...
		boolean qualify =
			childFeature == PpoPackage.Literals.PURCHASE_ORDER__SHIP_TO ||
			childFeature == PpoPackage.Literals.PURCHASE_ORDER__BILL_TO;
