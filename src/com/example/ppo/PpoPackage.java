...
public interface PpoPackage extends EPackage {
	...
	/**
	 * The meta object id for the '{@link com.example.ppo.impl.PPOPackageImpl <em>PPO Package</em>}' class.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @see com.example.ppo.impl.PPOPackageImpl
	 * @see com.example.ppo.impl.PpoPackageImpl#getPPOPackage()
	 * @generated
	 */
	int PPO_PACKAGE = 1;

	/**
	 * The number of structural features of the '<em>PPO Package</em>' class.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @generated
	 * @ordered
	 */
	int PPO_PACKAGE_FEATURE_COUNT = 0;

	/**
	 * The number of operations of the '<em>PPO Package</em>' class.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @generated
	 * @ordered
	 */
	int PPO_PACKAGE_OPERATION_COUNT = 0;
	...
	/**
	 * Returns the meta object for class '{@link com.example.ppo.PPOPackage <em>PPO Package</em>}'.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @return the meta object for class '<em>PPO Package</em>'.
	 * @see com.example.ppo.PPOPackage
	 * @generated
	 */
	EClass getPPOPackage();
	...
	interface Literals {
		...
		/**
		 * The meta object literal for the '{@link com.example.ppo.impl.PPOPackageImpl <em>PPO Package</em>}' class.
		 * <!-- begin-user-doc -->
		 * <!-- end-user-doc -->
		 * @see com.example.ppo.impl.PPOPackageImpl
		 * @see com.example.ppo.impl.PpoPackageImpl#getPPOPackage()
		 * @generated
		 */
		EClass PPO_PACKAGE = eINSTANCE.getPPOPackage();
