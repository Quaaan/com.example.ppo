...
public class PpoAdapterFactory extends AdapterFactoryImpl {
	...
	protected PpoSwitch<Adapter> modelSwitch =
		new PpoSwitch<Adapter>() {
			...
			@Override
			public Adapter casePPOPackage(PPOPackage object) {
				return createPPOPackageAdapter();
			}
			@Override
	...
	/**
	 * Creates a new adapter for an object of class '{@link com.example.ppo.PPOPackage <em>PPO Package</em>}'.
	 * <!-- begin-user-doc -->
	 * This default implementation returns null so that we can easily ignore cases;
	 * it's useful to ignore a case when inheritance will catch all the cases anyway.
	 * <!-- end-user-doc -->
	 ...
	 * @generated
	 */
	public Adapter createPPOPackageAdapter() {
		return null;
	}
